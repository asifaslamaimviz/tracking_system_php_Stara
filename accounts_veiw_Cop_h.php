                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="widget-content widget-content-area animated-underline-content">
                                                                        ...
                                                                        <ul class="nav nav-tabs  mb-3" id="animateLine1" role="tablist">
                                                                            <li class="nav-item">
                                                                                <a class="nav-link active" id="animated-underline-home-tab1" data-toggle="tab" href="#animated-underline-home1" role="tab" aria-controls="animated-underline-home1" aria-selected="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                                                                            ...
                                                                            <li class="nav-item">
                                                                                <a class="nav-link" id="animated-underline-profile-tab1" data-toggle="tab" href="#animated-underline-profile1" role="tab" aria-controls="animated-underline-profile1" aria-selected="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
                                                                            ...
                                                                            <li class="nav-item">
                                                                                <a class="nav-link" id="animated-underline-contact-tab1" data-toggle="tab" href="#animated-underline-contact" role="tab" aria-controls="animated-underline-contact" aria-selected="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone">
                                                                        ...
                                                                        <div class="tab-content" id="animateLineContent-4">
                                                                            <div class="tab-pane fade show active" id="animated-underline-home1" role="tabpanel" aria-labelledby="animated-underline-home-tab1">
                                                                                ...
                                                                                <div class="container-fluid">
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                                                            ...
                                                                                            <div class="user-profile layout-spacing " style="margin-top:-50px">
                                                                                                <div class="widget-content widget-content-area">
                                                                                                    ...
                                                                                                    <div class="text-center user-info">
                                                                                                        <img src="images/round-account-button-with-user-inside.svg" alt="avatar" style="width:100px">
                                                                                                        <p class="">
                                                                                                            <?php echo $data['name'] ?>
                                                                                                        </p>
                                                                                                    </div>
                                                                            ...
                                                                            <div class="tab-pane fade" id="animated-underline-profile1" role="tabpanel" aria-labelledby="animated-underline-profile-tab" 1>
                                                                                <div class="container-fluid">
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                                                            <button class="btn btn-outline-primary mb-2" data-toggle="modal" href="#add_doc1">Add
                                                                                                Documents</button>
                                                                                            <div class="modal fade" id="add_doc1" tabindex="-1" role="dialog" aria-labelledby="exampleModalTitle" aria-hidden="true">
                                                                                                        ...
                                                                                                        <form action="" method="post" enctype="multipart/form-data">
                                                                                                                        ...
                                                                                                                        <div class="col-md-12">
                                                                                                                            ...
                                                                                                                            <div class="form-row mb-3">
                                                                                                                                ...
                                                                                                                                <div class="form-group col-md-12">
                                                                                                                                    ...
                                                                                                                                    <input type="file" name="user_doc[]" id="user_doc" class="form-control" required multiple>
                                                                                                            ...
                                                                                                            <div class="modal-footer">
                                                                                                                <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i>
                                                                                                                    Cancel</button>
                                                                                                                <button class="btn btn-primary  font-weight-bold mx-2" name="submit6" type="submit" style="float: right; ">SAVE</button>
                                                                                                            </div>
                                                                                                        </form>
                                                                                                    </div>
                                                                                                </div>
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            ...
                                                                                                            ?>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td class="text-center">
                                                                                                                        <a href="uploads/<?php echo $row["user_doc"]; ?>" target="_blank">
                                                                                                        ...
                                                                                                        <a href="accounts_edit_Cop_h.php?id=<?php echo $row['id']; ?>&table=<?php echo $row["privilege"]; ?>"
                                                                                                            ...
                                                                                                            title="Edit"><svg
                                                                                                                ...
                                                                                                                <path
                                                                                                                    ...
                                                                                                                    <td class="text-center">
                                                                                                                        <svg data-id='<?= $row['id']; ?>' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-danger warning ">
                                                                            ...
                                                                            <div class="tab-pane fade" id="animated-underline-contact" role="tabpanel" aria-labelledby="animated-underline-contact-tab">
                                                                                <div class="container-fluid">
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                                                            <button class="btn btn-outline-primary   mb-2" data-toggle="modal" href="#b_contact">Add
                                                                                                Contact</button>

                                                                                            <div data-backdrop="static" class="modal fade bd-example-modal-xl" id="b_contact" tabindex="-1" role="dialog" aria-labelledby="exampleModalTitle" aria-hidden="true">
                                                                                                                        ...
                                                                                                                        <div class="container my-4">
                                                                                                                            ...
                                                                                                                            <div class="row">
                                                                                                                                <div class="col-md-12">
                                                                                                                                    <form action="" method="post" enctype="multipart/form-data">
                                                                                                                                        <div class="form-row mb-3">
                                                                                                                                            <input type="hidden" class="form-control" id="main_id" name="main_id" value="<?php echo $row["id"]; ?>" placeholder="Enter Name">
                                                                                                                                            <div class="form-group col-md-6">
                                                                                                                                                <label for="inputEmail4">Name</label>
                                                                                                                                                <input type="text" class="form-control" id="fname1" name="fname1" placeholder="Enter Name" required>
                                                                                                                                            </div>

                                                                                                                                            <div class="form-group col-md-6  ">
                                                                                                                                                <label for="" class="lab">Email</label>
                                                                                                                                                <input type="email" class="form-control" id="email1" name="email1" placeholder="Enter Name" required></svg>
                                                                                                                                            </div>
                                                                                                                                            <div class="form-group col-md-6 ">
                                                                                                                                                <label for="" class="lab">Phone</label><input type="text" class="form-control" id="phone1" name="phone1" placeholder="Enter Name" required>
                                                                                                                                            </div>
                                                                                                                                            <div class="form-group col-md-6 ">
                                                                                                                                                <label for="" class="lab">Mobile</label><input type="text" class="form-control" id="mobile1" name="mobile1" placeholder="Enter Name" required>
                                                                                                                                            </div>
                                                                                                                                            <div class="form-group col-md-6 ">
                                                                                                                                                <label for="" class="lab">NIC
                                                                                                                                                    #</label><input type="text" class="form-control" id="nic1" name="nic1" placeholder="Enter Name" required>
                                                                                                                                            </div>
                                                                                                                                            <div class="form-group col-md-6 ">
                                                                                                                                                <label for="" class="lab">Alternate
                                                                                                                                                    Phone</label><input type="text" class="form-control" id="aphone1" name="aphone1" placeholder="Enter Name" required>
                                                                                                                                            </div>
                                                                                                                                            <div class="form-group col-md-6 ">
                                                                                                                                                <label for="" class="lab">Fax</label><input type="text" class="form-control" id="fax1" name="fax1" placeholder="Enter Name" required>
                                                                                                                                            </div>
                                                                                                                                            <div class="form-group col-md-6 ">
                                                                                                                                                <label for="" class="lab">Mailing
                                                                                                                                                    Address</label><input type="text" class="form-control" id="mail1" name="mail1" placeholder="Enter Name" required>
                                                                                                                                            </div>
                                                                                                                                            <div class="form-group col-md-6 ">
                                                                                                                                                <label for="" class="lab">Availability
                                                                                                                                                    Timings</label><input type="text" class="form-control" id="ava1" name="ava1" placeholder="Enter Name" required>
                                                                                                                                            </div>
                                                                                                                                            <div class="form-group col-md-6 ">
                                                                                                                                                <label for="" class="lab">Other
                                                                                                                                                    Address</label><input type="text" class="form-control" id="other1" name="other1" placeholder="Enter Name" required>
                                                                                                                                            </div>
                                                                                                                                        ...
                                                                                                                                        <div class="container">
                                                                                                                                            ...
                                                                                                                                            <div class="row">
                                                                                                                                                ...
                                                                                                                                                <div class="col-md-12">
                                                                                                                                                    <button class="btn btn-primary  font-weight-bold mx-2" name="submit5" type="submit" style="float: right; ">SAVE</button>
                                                    ...
                                                    <div class="container-fluid mt-4">
                                                        ...
                                                        <div class="row">
                                                            <div class="widget-content widget-content-area animated-underline-content">
                                                                ...
                                                                <ul class="nav nav-tabs  mb-3" id="animateLine2" role="tablist">
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" id="animated-underline-home-tab2" data-toggle="tab" href="#animated-underline-home2" role="tab" aria-controls="animated-underline-home2" aria-selected="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                                                                                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z">
                                                                                </path>
                                                                                <polyline points="9 22 9 12 15 12 15 22">
                                                                                </polyline>
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" id="animated-underline-profile-tab2" data-toggle="tab" href="#animated-underline-profile2" role="tab" aria-controls="animated-underline-profile2" aria-selected="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
                                                                                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2">
                                                                                </path>
                                                                                <circle cx="12" cy="7" r="4"></circle>
                                                                            </svg> User Documents</a>
                                                                ...
                                                                <div class="tab-content" id="animateLineContent-4">
                                                                    <div class="tab-pane fade show active" id="animated-underline-home2" role="tabpanel" aria-labelledby="animated-underline-home-tab2">
                                                                    ...
                                                                    <div class="tab-pane fade" id="animated-underline-profile2" role="tabpanel" aria-labelledby="animated-underline-profile-tab2">
                                                                        <div class="container-fluid">
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <button class="btn btn-outline-primary mb-2" data-toggle="modal" href="#add_doc2">Add
                                                                                        Documents</button>
                                                                                    <div class="modal fade" id="add_doc2" tabindex="-1" role="dialog" aria-labelledby="exampleModalTitle" aria-hidden="true">
                                                                                        <div class="modal-dialog " role="document">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    ?>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td class="text-center">
                                                                                                                <a href="uploads/<?php echo $row3["user_doc"]; ?>" target="_blank">
                                                                                                        ...
                                                                                                        <a href="accounts_edit_Cop_h.php?id=<?php echo $row3['id']; ?>&table=<?php echo $row3["privilege"]; ?>"
                                                                                                            ...
                                                                                                            <td class="text-center">
                                                                                                                <svg data-id='<?= $row3['id']; ?>' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-danger warning delete">
                                                                                                                    <polyline points="3 6 5 6 21 6">
                                                                                                                    </polyline>
                                                                                                                    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2">
                                                                                                                    </path>
                                                                ...
                                                                <div class="tab-content" id="animateLineContent-4">
                                                                    ...
                                                                    <div class="tab-pane fade" id="animated-underline-profile" role="tabpanel" aria-labelledby="animated-underline-profile-tab">
                                                                        <div class="container-fluid">
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <button class="btn btn-outline-primary mb-2" data-toggle="modal" href="#add_doc">Add
                                                                                        Documents</button>
                                                                                    <div class="modal fade" id="add_doc" tabindex="-1" role="dialog" aria-labelledby="exampleModalTitle" aria-hidden="true">
                                                                                        <div class="modal-dialog " role="document">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    ?>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td class="text-center">
                                                                                                                <a href="uploads/<?php echo $row2["user_doc"]; ?>" target="_blank">
                                                                                                        ...
                                                                                                        <a href="accounts_edit_Cop_h.php?id=<?php echo $row2['id']; ?>&table=<?php echo $row["privilege"]; ?>"
                                                                                                            ...
                                                                                                            <td class="text-center">
                                                                                                                <svg data-id='<?= $row2['id']; ?>' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-danger warning delete">
                                                                                                                    <polyline points="3 6 5 6 21 6">
                                                                                                                    </polyline>
                                                                                                                    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2">
                                                                                                                    </path>
