                                            ...
                                            <form action="family_product.php" method="post">
                                                <div class="form-row mb-4">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter Product Family" required>
                                                    </div>
                                                    <div class="form-group col-md-6" id="select_box">
                                                        <label for="inputEmail4">Type</label>
                                                        <select id="sel_depart" name="sel_depart" onchange="fetch_select(this.value);" class="form-control ">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="new_select" name="new_select" class="form-control " required>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input id="basicFlatpickr" name="basicFlatpickr" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Issue Date..">
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4">Expiry Date</label>
                                                        <input id="basicFlatpickr1" name="basicFlatpickr1" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Expiry Date..">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="i_t_company" name="i_t_company" placeholder="Enter Insurance / Tracker Company" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="ntn" name="ntn" placeholder="Enter NTN" required>
                                                    </div>

                                                    <div class="form-group col-md-6 "><label for="" class="lab">Decumentation</label><input type="file" class="form-control" id="file" name="file" placeholder="Decumentation" required>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4">Sum Insured</label>
                                                        <input type="text" class="form-control" id="s_insured" name="s_insured" placeholder="Enter Sum Insured" required>
                                                    </div>


                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4">Net Premium </label>
                                                        <input type="text" class="form-control" id="net_premium" name="net_premium" placeholder="Enter Net Premium" required>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4">Gross Premium </label>
                                                        <input type="text" class="form-control" id="gross_premium" name="gross_premium" placeholder="Enter Gross Premium" required>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4">Perils Cover </label>
                                                        <input type="text" class="form-control" id="p_cover" name="p_cover" placeholder="Enter Perils Cover" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="i_c" name="i_c" placeholder="Enter Insurance Company Representative (Contact)" required>
                                                    </div>
                                                </div>
