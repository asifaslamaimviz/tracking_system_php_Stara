...
$asset = "SELECT warehouse_name , warehouse_id from  warehouse";
$resultdevice = mysqli_query($db, $asset);

$users = "SELECT * FROM `devices`";
...
if (!empty($_POST)) {
    ...
    $user = mysqli_real_escape_string($db, $_POST["user"]); {
        $query = "INSERT INTO  v_warehouse (`vehicle_id`,`warehouse_id`,`dateposted`)VALUES ('$assign','$user','$date')";
                ...
                <li class="nav-item align-self-center page-heading">
                    <div class="page-header">
                        <div class="page-title">
                            <h3>Warehouse Assign To User</h3>
                        </div>
                    </div>
                </li>
            </ul>
                                            ...
                                            <form action="" method="post">
                                                <div class="form-row mb-4">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="assign" name="assign" class="form-control tagging selectpicker basic">
