...
<body class="sidebar-noneoverflow starterkit">
  ...
  <div class="main-container" id="container">
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
              ...
              <div class="container-fluid mt-4">
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary" id="add" data-toggle="modal" data-target="#zoomupModal">Add Warehouse</button>
                  ...
                  <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center">Warehous Name</th>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-center"><?php echo $row["warehouse_name"]; ?></td>
    ...
    <?php
    $brands = $db->query("SELECT * FROM warehouse WHERE warehouse_id > 0");
    while ($row = $brands->fetch_array()) { ?>


      <div aria-hidden="true" class="modal delete_warehouse" id="delete_warehouse<?php echo $row['warehouse_id'] ?>" role="dialog">
    ...
    <div id="zoomupModal" class="modal animated zoomInUp custo-zoomInUp" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" style="color:#000" id="title_edit">Add Warehouse</h5>
                  ...
                  <form method="post" id="insert_form" enctype="multipart/form-data">
                    <div class="form-row mb-4">
                      <div class="form-group col-md-12">
                        <label for="inputEmail4">Warehouse Name</label>
                        <input type="text" class="form-control" id="cname" name="cname" placeholder="Enter Warehouse">
                      </div>

                      <div class="form-group col-md-12">
                        <label for="inputEmail4">Describtion</label>
                        <input type="text" class="form-control" id="d_cnic" name="d_cnic" placeholder="Enter Describtion">
                      </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#insert_form').on("submit", function(event) {
          ...
          if ($('#cname').val() == "") {
            ...
            alert("Describtion is required");


          } else {
            $.ajax({
              url: "wharehouse/insert_warehouse.php",
              method: "POST",
        ...
        $(document).on('click', '.edit_data', function() {
          ...
          // alert(employee_id)
          $.ajax({
            url: "wharehouse/update_warehouse.php",
            method: "POST",
            data: {
      ...
      $(document).on('click', '#delete_warehouse', function() {
        ...
        // alert(ids);
        $.ajax({
          url: "wharehouse/delete_warehouse.php",
          type: "post",
          data: "warehouse_id=" + ids,
          success: function(data) {
            $('.delete_warehouse').modal('hide');
            $('#html5-extension').trigger('reset');
          }
        });
      });
    </script>
